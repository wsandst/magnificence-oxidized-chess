...
impl Board {
    ...
    pub fn get_moves(&self) -> Vec<Move> {
        ...
        match self.current_player {
            Color::White => self.generate_moves_white(&mut moves, black_occupancy, white_occupancy),
            Color::Black => self.generate_moves_black(&mut moves, black_occupancy, white_occupancy)
        }
        return moves;
    }
